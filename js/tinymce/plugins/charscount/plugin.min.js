(function() {
    var wordcount = (function() {
        ...
        var classify = function(string) {
            ...
            /* if (new RegExp(regExps.KATAKANA).test(string) == true) {
                 return [];
             } */
            if (string.charAt(0) == "\n") {
                return [];
            ...
            //  console.log(string.match(regExps.KATAKANA));

            var stringed = string.replace(/\s\s+/g, ' ');
            stringed = stringed.replace("/\n+/g", "");

            return $_3uizbntjjkmcwsen.map(stringed.split(''), memoized);
        };
        ...
        var getCount = function(editor) {
            ...
            //  console.log($_5uy6wmtijkmcwsel.classify(getTextContent(editor)).length);
            return $_5uy6wmtijkmcwsel.classify(getTextContent(editor)).length;
        ...
        var setup = function(editor) {
            ...
            var update = function() {
                editor.theme.panel.find('#charscount').text(wordsToText(editor));
            };
        ...
        global.add('charscount', function(editor) {
